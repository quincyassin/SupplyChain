...
/**
 * 导入分单订单明细（物理归档表 import_order_archive）
 *
 * @author huangxinsong
 */
@Entity
@Table(
        name = "import_order_archive",
        indexes = {
            @Index(name = "idx_import_order_archive_task_id", columnList = "task_id"),
            @Index(name = "idx_import_order_archive_merchant", columnList = "merchant"),
            @Index(name = "idx_import_order_archive_platform", columnList = "platform"),
            @Index(name = "idx_import_order_archive_issue_date", columnList = "issue_date"),
            @Index(name = "idx_import_order_archive_receipt_status", columnList = "receipt_status"),
            @Index(name = "idx_import_order_archive_after_sales", columnList = "after_sales"),
            @Index(name = "idx_import_order_archive_after_sales_status", columnList = "after_sales_status")
        })
@Getter
@Setter
public class ImportOrderArchive {
